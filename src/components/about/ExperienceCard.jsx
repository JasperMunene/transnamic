...
const ExperienceCard = () => (
    <div className="relative overflow-hidden rounded-3xl 2xl:h-[550px] 2xl:w-[700px] w-auto h-auto">
        <img
        ...
        <div className="absolute bottom-8 left-8">
            <div className="mb-2 bg-red-600 rounded-full flex items-center justify-center text-white text-6xl font-bold w-24 h-24">
                <AnimatedCounter end={12} className="text-white" />
            </div>
